            ...
            <DialogContent>
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div className="form-group" style={{ width: "33%" }}>
                  ...
                  <Typography>{showDetailsModal.FullName}</Typography>
                </div>
                <div className="form-group" style={{ width: "33%" }}>
                  <Typography color="textSecondary">EmailID</Typography>
                  <Typography>{showDetailsModal.EmailID}</Typography>
                </div>
                <div className="form-group" style={{ width: "33%" }}>
                  <Typography color="textSecondary">MobileNo</Typography>
                  <Typography>{showDetailsModal.MobileNo}</Typography>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div className="form-group" style={{ width: "33%" }}>
                  ...
                  <Typography>{showDetailsModal.Location}</Typography>
                </div>
                <div className="form-group" style={{ width: "33%" }}>
                  <Typography color="textSecondary">CreatedAt</Typography>
                  <Typography>{showDetailsModal.CreatedAt}</Typography>
                </div>
                <div className="form-group" style={{ width: "33%" }}>
                  <Typography color="textSecondary">Experience</Typography>
                  <Typography>{showDetailsModal.Experience}</Typography>
                </div>
              </div>
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div className="form-group" style={{ width: "33%" }}>
                  ...
                  <Typography>{showDetailsModal.Age}</Typography>
                </div>
                <div className="form-group" style={{ width: "33%" }}>
                  <Typography color="textSecondary">Coaching Type</Typography>
                  <List>
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div className="form-group" style={{ width: "50%" }}>
                  <Typography color="textSecondary">Coaching Time</Typography>
                  <List>

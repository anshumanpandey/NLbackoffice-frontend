  ...
  return (
    <>
      <div className="row">
        ...
        {showCreate && (
          <CreateScheduledNotificationForm
        ...
        >
          <DialogTitle id="alert-dialog-title">
            Do want to delete {showModal.FullName}
          </DialogTitle>
          <DialogContent>
          ...
          <DialogActions>
            <Button
              ...
              style={{ opacity: deleteReq.loading ? 0.5 : 1 }}
              autoFocus
            ...
            <Button
              ...
              onClick={() => {
                doDelete({
                  url: `/scheduledNotification/delete`,
                  data: { id: showModal._id },
                })
